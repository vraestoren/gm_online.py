...
class GmOnline:
	...
	def login(
		...
		response = self._post("/LoginWithPlayFab", data=data)
	...
	def register(
		...
		return self._post("/RegisterPlayFabUser", data=data)
	...
	def get_store_items(
		...
		return self._post("/GetStoreItems", data=data)
	...
	def finish_video(self) -> dict:
		...
		return self._post("/ExecuteCloudScript", data=data)

	def update_username(self, username: str) -> dict:
		data = {
			"DisplayName": username
		}
		return self._post("/UpdateUserTitleDisplayName", data=data)
	...
	def get_friend_list(
		...
		return self._post("/GetFriendsList", data=data)
	...
	def purchase_item(
		...
		return self._post("/PurchaseItem", data=data)
	...
	def unlock_container_instance(
		...
		return self._post("/UnlockContainerInstance", data=data)
	...
	def update_avatar_url(self, image_url: str) -> dict:
		...
		return self._post("/UpdateAvatarUrl", data=data)
	...
	def send_account_recovery_mail(self, email: str) -> dict:
		...
		return self._post("/SendAccountRecoveryEmail", data=data)
	...
	def get_catalog_items(
		...
		return self._post("/GetCatalogItems", data=data)
		
	def update_email(self, email: str) -> dict:
		data = {
			"EmailAddress": email
		}
		return self._post("/AddOrUpdateContactEmail", data=data)
